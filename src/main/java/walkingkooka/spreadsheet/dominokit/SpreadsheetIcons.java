...
public final class SpreadsheetIcons implements PublicStaticHelper {
    ...
    public static MdiIcon currency() {
    ...
    public static MdiIcon textDecorationLineClear() {
        return Icons.format_clear();
    }
    ...
    public static MdiIcon value() {
        return Icons.numeric();
    }

    public static MdiIcon valueRemove() {
        return Icons.close();
    }
