...
final class SpreadsheetCellValueDialogComponentContextDateTime implements SpreadsheetCellValueDialogComponentContext<LocalDateTime>,
    HistoryContextDelegator,
    LoggingContextDelegator {

    static SpreadsheetCellValueDialogComponentContextDateTime with(final SpreadsheetViewportCache viewportCache,
                                                                   final HasSpreadsheetDeltaFetcherWatchers deltaFetcherWatchers,
                                                                   final JsonNodeMarshallContext marshallContext,
                                                                   final HistoryContext historyContext,
                                                                   final LoggingContext loggingContext) {
        return new SpreadsheetCellValueDialogComponentContextDateTime(
    ...
    private SpreadsheetCellValueDialogComponentContextDateTime(final SpreadsheetViewportCache viewportCache,
                                                               final HasSpreadsheetDeltaFetcherWatchers deltaFetcherWatchers,
                                                               final JsonNodeMarshallContext marshallContext,
                                                               final HistoryContext historyContext,
                                                               final LoggingContext loggingContext) {
    ...
    public ValidationValueTypeName valueType() {
        return ValidationValueTypeName.DATE_TIME;
    }
    ...
    @Override
    public String toHistoryTokenSaveStringValue(final Optional<LocalDateTime> value) {
