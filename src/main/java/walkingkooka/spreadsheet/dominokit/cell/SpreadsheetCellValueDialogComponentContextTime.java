...
final class SpreadsheetCellValueDialogComponentContextTime implements SpreadsheetCellValueDialogComponentContext<LocalTime>,
    HistoryContextDelegator,
    LoggingContextDelegator {

    static SpreadsheetCellValueDialogComponentContextTime with(final SpreadsheetViewportCache viewportCache,
                                                               final HasSpreadsheetDeltaFetcherWatchers deltaFetcherWatchers,
                                                               final JsonNodeMarshallContext marshallContext,
                                                               final HistoryContext historyContext,
                                                               final LoggingContext loggingContext) {
        return new SpreadsheetCellValueDialogComponentContextTime(
    ...
    private SpreadsheetCellValueDialogComponentContextTime(final SpreadsheetViewportCache viewportCache,
                                                           final HasSpreadsheetDeltaFetcherWatchers deltaFetcherWatchers,
                                                           final JsonNodeMarshallContext marshallContext,
                                                           final HistoryContext historyContext,
                                                           final LoggingContext loggingContext) {
