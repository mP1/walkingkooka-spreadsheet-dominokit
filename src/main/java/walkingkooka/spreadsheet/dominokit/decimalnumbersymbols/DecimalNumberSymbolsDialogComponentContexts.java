...
public final class DecimalNumberSymbolsDialogComponentContexts implements PublicStaticHelper {
    ...
    /**
     * {@see FakeDecimalNumberSymbolsDialogComponentContext}
     */
    public static DecimalNumberSymbolsDialogComponentContext fake() {
        return new FakeDecimalNumberSymbolsDialogComponentContext();
    }

    private DecimalNumberSymbolsDialogComponentContexts() {
