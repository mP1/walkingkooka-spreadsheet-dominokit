...
/**
 * A container component with 3 columns, using a CSS grid.
 */
public final class ThreeColumnComponent implements HtmlComponentDelegator<HTMLDivElement, ThreeColumnComponent>,
    ComponentWithChildren<ThreeColumnComponent, HTMLDivElement> {

    public static ThreeColumnComponent empty() {
        return new ThreeColumnComponent();
    }

    private ThreeColumnComponent() {
        super();
        this.div = DivComponent.div()
            .setCssText("display: grid; grid-template-columns: 33% 33% 33%; gap: 5px;");
    ...
    @Override
    public ThreeColumnComponent setId(final String id) {
        this.div.setId(id);
        return this;
    }
    ...
    @Override
    public ThreeColumnComponent appendChild(final IsElement<?> child) {
     ...
     */
    @Override
    public ThreeColumnComponent removeChild(final int index) {
