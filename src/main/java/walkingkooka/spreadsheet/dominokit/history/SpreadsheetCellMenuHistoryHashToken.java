...
public final class SpreadsheetCellMenuHistoryHashToken extends SpreadsheetCellHistoryHashToken {
    ...
    static SpreadsheetCellMenuHistoryHashToken with(final SpreadsheetId id,
                                                    final SpreadsheetName name,
                                                    final SpreadsheetViewportSelection viewportSelection) {
        return new SpreadsheetCellMenuHistoryHashToken(
                id,
                name,
                viewportSelection
        );
    ...
    private SpreadsheetCellMenuHistoryHashToken(final SpreadsheetId id,
                                                final SpreadsheetName name,
                                                final SpreadsheetViewportSelection viewportSelection) {
        super(
                id,
