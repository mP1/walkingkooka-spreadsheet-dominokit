...
public final class SpreadsheetCellNavigateHistoryToken extends SpreadsheetCellHistoryToken {
    ...
    static SpreadsheetCellNavigateHistoryToken with(final SpreadsheetId spreadsheetId,
    ...
    private SpreadsheetCellNavigateHistoryToken(final SpreadsheetId spreadsheetId,
                                                final SpreadsheetName spreadsheetName,
                                                final AnchoredSpreadsheetSelection anchoredSelection,
                                                final Optional<SpreadsheetViewportHomeNavigationList> navigation) {
        super(
