...
public final class SpreadsheetCellPatternSaveHistoryHashToken extends SpreadsheetCellPatternHistoryHashToken {
    ...
    static SpreadsheetCellPatternSaveHistoryHashToken with(final SpreadsheetId id,
    ...
    private SpreadsheetCellPatternSaveHistoryHashToken(final SpreadsheetId id,
                                                       final SpreadsheetName name,
                                                       final SpreadsheetViewportSelection viewportSelection,
                                                       final SpreadsheetPattern pattern) {
        super(
