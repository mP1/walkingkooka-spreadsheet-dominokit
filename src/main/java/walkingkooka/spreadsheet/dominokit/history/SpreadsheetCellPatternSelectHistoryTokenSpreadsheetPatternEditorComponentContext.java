...
import walkingkooka.spreadsheet.dominokit.pattern.SpreadsheetPatternEditorComponentContext;
...
final class SpreadsheetCellPatternSelectHistoryTokenSpreadsheetPatternEditorComponentContext implements SpreadsheetPatternEditorComponentContext {

    static SpreadsheetCellPatternSelectHistoryTokenSpreadsheetPatternEditorComponentContext with(final AppContext context) {

        return new SpreadsheetCellPatternSelectHistoryTokenSpreadsheetPatternEditorComponentContext(context);
    }

    private SpreadsheetCellPatternSelectHistoryTokenSpreadsheetPatternEditorComponentContext(final AppContext context) {
    ...
    public void setPatternKind(final SpreadsheetPatternKind patternKind) {
        ...
        context.debug("SpreadsheetCellPatternSelectHistoryTokenSpreadsheetPatternEditorComponentContext.setPatternKind " + patternKind);
