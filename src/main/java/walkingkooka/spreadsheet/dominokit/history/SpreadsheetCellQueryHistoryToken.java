 ...
 * <pre>
 * http://localhost:12345/index.html#/2/Untitled/cell/A1/query/path/LR-TB/offset/0/count/100/value-type/any/query/true()
 * http://localhost:12345/api/spreadsheet-id/spreadsheet-name/cell/cell-Or-cell-range-OR-label/query/path/LR-TB/offset/0/count/0/value-type/any/query/formula-expression-to-execute-for-each-candidate-cell.
 * </pre>
 */
public final class SpreadsheetCellQueryHistoryToken extends SpreadsheetCellHistoryToken {
    ...
    UrlFragment cellUrlFragment() {
        return QUERY.append(this.query.urlFragment());
    }
