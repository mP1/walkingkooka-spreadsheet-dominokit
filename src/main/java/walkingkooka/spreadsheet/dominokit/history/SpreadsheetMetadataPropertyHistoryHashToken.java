...
public abstract class SpreadsheetMetadataPropertyHistoryHashToken<T> extends SpreadsheetMetadataHistoryHashToken {

    SpreadsheetMetadataPropertyHistoryHashToken(final SpreadsheetId id,
