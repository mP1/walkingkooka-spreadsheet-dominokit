...
public final class SpreadsheetImporterInfoSetComponent implements ValueSpreadsheetTextBoxWrapper<SpreadsheetImporterInfoSetComponent, SpreadsheetImporterInfoSet> {
    ...
    @Override
    public ValueSpreadsheetTextBox<SpreadsheetImporterInfoSet> parserSpreadsheetTextBox() {
        return this.textBox;
    }

    private final ValueSpreadsheetTextBox<SpreadsheetImporterInfoSet> textBox;
