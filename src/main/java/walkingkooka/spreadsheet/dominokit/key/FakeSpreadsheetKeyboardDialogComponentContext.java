...
public class FakeSpreadsheetKeyboardDialogComponentContext extends FakeDialogComponentContext implements
    SpreadsheetKeyboardDialogComponentContext {

    public FakeSpreadsheetKeyboardDialogComponentContext() {
        super();
    }
