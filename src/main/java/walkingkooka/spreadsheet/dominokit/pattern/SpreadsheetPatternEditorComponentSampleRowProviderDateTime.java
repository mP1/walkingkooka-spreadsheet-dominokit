...
abstract class SpreadsheetPatternEditorComponentSampleRowProviderDateTime extends SpreadsheetPatternEditorComponentSampleRowProvider {

    SpreadsheetPatternEditorComponentSampleRowProviderDateTime() {
        super();
    }
