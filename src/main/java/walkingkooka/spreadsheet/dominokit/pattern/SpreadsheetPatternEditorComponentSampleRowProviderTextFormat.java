 ...
 */
final class SpreadsheetPatternEditorComponentSampleRowProviderTextFormat extends SpreadsheetPatternEditorComponentSampleRowProvider {

    /**
     * Singleton
     */
    final static SpreadsheetPatternEditorComponentSampleRowProviderTextFormat INSTANCE = new SpreadsheetPatternEditorComponentSampleRowProviderTextFormat();

    private SpreadsheetPatternEditorComponentSampleRowProviderTextFormat() {
        super();
    }
