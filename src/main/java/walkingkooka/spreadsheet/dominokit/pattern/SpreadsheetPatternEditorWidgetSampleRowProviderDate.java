...
abstract class SpreadsheetPatternEditorWidgetSampleRowProviderDate extends SpreadsheetPatternEditorWidgetSampleRowProvider {

    SpreadsheetPatternEditorWidgetSampleRowProviderDate() {
        super();
    }
