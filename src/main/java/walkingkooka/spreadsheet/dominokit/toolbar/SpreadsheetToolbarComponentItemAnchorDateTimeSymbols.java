...
final class SpreadsheetToolbarComponentItemAnchorDateTimeSymbols extends SpreadsheetToolbarComponentItemAnchor<SpreadsheetToolbarComponentItemAnchorDateTimeSymbols>
    ...
    static SpreadsheetToolbarComponentItemAnchorDateTimeSymbols with(final SpreadsheetToolbarComponentContext context) {
        return new SpreadsheetToolbarComponentItemAnchorDateTimeSymbols(context);
    }

    private SpreadsheetToolbarComponentItemAnchorDateTimeSymbols(final SpreadsheetToolbarComponentContext context) {
        super(
            SpreadsheetToolbarComponent.dateTimeSymbolsId(),
            Optional.of(
