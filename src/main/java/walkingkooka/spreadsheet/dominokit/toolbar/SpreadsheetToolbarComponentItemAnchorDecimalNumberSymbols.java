 ...
 */
final class SpreadsheetToolbarComponentItemAnchorDecimalNumberSymbols extends SpreadsheetToolbarComponentItemAnchor<SpreadsheetToolbarComponentItemAnchorDecimalNumberSymbols>
    implements SpreadsheetCellComponentLifecycle,
    NopComponentLifecycleRefresh,
    NopComponentLifecycleOpenGiveFocus {

    static SpreadsheetToolbarComponentItemAnchorDecimalNumberSymbols with(final SpreadsheetToolbarComponentContext context) {
        return new SpreadsheetToolbarComponentItemAnchorDecimalNumberSymbols(context);
    }

    private SpreadsheetToolbarComponentItemAnchorDecimalNumberSymbols(final SpreadsheetToolbarComponentContext context) {
        super(
            SpreadsheetToolbarComponent.decimalNumberSymbolsId(),
            Optional.of(
