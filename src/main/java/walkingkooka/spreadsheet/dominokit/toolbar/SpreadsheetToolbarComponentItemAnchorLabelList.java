 ...
 */
final class SpreadsheetToolbarComponentItemAnchorLabelList extends SpreadsheetToolbarComponentItemAnchor<SpreadsheetToolbarComponentItemAnchorLabelList>
    implements NopComponentLifecycleOpenGiveFocus,
    NopComponentLifecycleRefresh {

    static SpreadsheetToolbarComponentItemAnchorLabelList with(final SpreadsheetToolbarComponentContext context) {
        return new SpreadsheetToolbarComponentItemAnchorLabelList(context);
    }

    private SpreadsheetToolbarComponentItemAnchorLabelList(final SpreadsheetToolbarComponentContext context) {
        super(
            SpreadsheetToolbarComponent.labelListId(),
            Optional.of(
        ...
        this.labelList = SpreadsheetLabelListAnchorComponent.with(
            anchor,
            anchor.id(),
            context
        );
    ...
    private final SpreadsheetLabelListAnchorComponent labelList;
