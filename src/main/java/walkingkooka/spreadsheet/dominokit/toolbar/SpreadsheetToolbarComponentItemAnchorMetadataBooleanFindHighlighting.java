...
final class SpreadsheetToolbarComponentItemAnchorMetadataBooleanFindHighlighting extends SpreadsheetToolbarComponentItemAnchorMetadataBoolean<SpreadsheetToolbarComponentItemAnchorMetadataBooleanFindHighlighting> {
    ...
    static SpreadsheetToolbarComponentItemAnchorMetadataBooleanFindHighlighting with(final SpreadsheetToolbarComponentContext context) {
        return new SpreadsheetToolbarComponentItemAnchorMetadataBooleanFindHighlighting(context);
    }

    private SpreadsheetToolbarComponentItemAnchorMetadataBooleanFindHighlighting(final SpreadsheetToolbarComponentContext context) {
        super(
