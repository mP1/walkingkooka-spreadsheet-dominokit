 ...
 */
final class SpreadsheetToolbarComponentItemAnchorValidator extends SpreadsheetToolbarComponentItemAnchor<SpreadsheetToolbarComponentItemAnchorValidator>
    implements SpreadsheetCellComponentLifecycle,
    NopComponentLifecycleRefresh,
    NopComponentLifecycleOpenGiveFocus {

    static SpreadsheetToolbarComponentItemAnchorValidator with(final SpreadsheetToolbarComponentContext context) {
        return new SpreadsheetToolbarComponentItemAnchorValidator(context);
    }

    private SpreadsheetToolbarComponentItemAnchorValidator(final SpreadsheetToolbarComponentContext context) {
        super(
            SpreadsheetToolbarComponent.validatorId(),
            Optional.of(
