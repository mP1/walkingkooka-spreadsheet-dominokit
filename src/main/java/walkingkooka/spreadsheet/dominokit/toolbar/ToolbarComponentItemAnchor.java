 ...
 */
abstract class ToolbarComponentItemAnchor<C extends ToolbarComponentItemAnchor<C>> extends ToolbarComponentItem<C>
    implements HtmlComponentDelegator<HTMLElement, C> {

    ToolbarComponentItemAnchor(final String id,
