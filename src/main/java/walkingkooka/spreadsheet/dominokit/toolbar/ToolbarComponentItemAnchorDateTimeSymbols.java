 ...
 */
final class ToolbarComponentItemAnchorDateTimeSymbols extends ToolbarComponentItemAnchor<ToolbarComponentItemAnchorDateTimeSymbols>
    implements SpreadsheetCellComponentLifecycle,
    NopComponentLifecycleRefresh,
    NopComponentLifecycleOpenGiveFocus {

    static ToolbarComponentItemAnchorDateTimeSymbols with(final ToolbarComponentContext context) {
        return new ToolbarComponentItemAnchorDateTimeSymbols(context);
    }
