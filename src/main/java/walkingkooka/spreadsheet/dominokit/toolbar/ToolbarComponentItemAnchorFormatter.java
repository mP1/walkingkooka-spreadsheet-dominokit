 ...
 */
final class ToolbarComponentItemAnchorFormatter extends ToolbarComponentItemAnchor<ToolbarComponentItemAnchorFormatter>
    implements SpreadsheetCellComponentLifecycle,
    NopComponentLifecycleRefresh,
    NopComponentLifecycleOpenGiveFocus {

    static ToolbarComponentItemAnchorFormatter with(final ToolbarComponentContext context) {
        return new ToolbarComponentItemAnchorFormatter(context);
    }
