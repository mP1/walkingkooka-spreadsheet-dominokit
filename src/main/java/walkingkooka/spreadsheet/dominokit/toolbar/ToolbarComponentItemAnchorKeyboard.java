...
final class ToolbarComponentItemAnchorKeyboard extends ToolbarComponentItemAnchor<ToolbarComponentItemAnchorKeyboard>
    implements NopComponentLifecycleOpenGiveFocus,
    NopComponentLifecycleRefresh {

    static ToolbarComponentItemAnchorKeyboard with(final ToolbarComponentContext context) {
        return new ToolbarComponentItemAnchorKeyboard(context);
    }

    private ToolbarComponentItemAnchorKeyboard(final ToolbarComponentContext context) {
        super(
            ToolbarComponent.KEYBOARD_ID,
            Optional.of(
                SpreadsheetIcons.keyboard()
            ),
            "Keyboard Help",
