 ...
 */
final class ToolbarComponentItemAnchorLabelList extends ToolbarComponentItemAnchor<ToolbarComponentItemAnchorLabelList>
    implements NopComponentLifecycleOpenGiveFocus,
    NopComponentLifecycleRefresh {

    static ToolbarComponentItemAnchorLabelList with(final ToolbarComponentContext context) {
        return new ToolbarComponentItemAnchorLabelList(context);
    }
