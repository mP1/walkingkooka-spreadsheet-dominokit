...
/**
 * A link ui that may exist withing a toolbar, which actives the locale dialog
 */
final class ToolbarComponentItemAnchorLocale extends ToolbarComponentItemAnchor<ToolbarComponentItemAnchorLocale>
    implements SpreadsheetCellComponentLifecycle,
    NopComponentLifecycleRefresh,
    NopComponentLifecycleOpenGiveFocus {

    static ToolbarComponentItemAnchorLocale with(final ToolbarComponentContext context) {
        return new ToolbarComponentItemAnchorLocale(context);
    }

    private ToolbarComponentItemAnchorLocale(final ToolbarComponentContext context) {
        super(
            ToolbarComponent.LOCALE_ID,
            Optional.of(
