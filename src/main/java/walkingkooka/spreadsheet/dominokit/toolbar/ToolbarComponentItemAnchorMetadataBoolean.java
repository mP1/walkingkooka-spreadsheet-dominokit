 ...
 */
abstract class ToolbarComponentItemAnchorMetadataBoolean<T extends ToolbarComponentItemAnchorMetadataBoolean<T>> extends ToolbarComponentItemAnchorMetadata<T> {

    ToolbarComponentItemAnchorMetadataBoolean(final String id,
