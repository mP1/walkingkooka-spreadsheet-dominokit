 ...
 */
final class ToolbarComponentItemAnchorMetadataBooleanHideZeroValues extends ToolbarComponentItemAnchorMetadataBoolean<ToolbarComponentItemAnchorMetadataBooleanHideZeroValues> {

    static ToolbarComponentItemAnchorMetadataBooleanHideZeroValues with(final ToolbarComponentContext context) {
        return new ToolbarComponentItemAnchorMetadataBooleanHideZeroValues(context);
    }
