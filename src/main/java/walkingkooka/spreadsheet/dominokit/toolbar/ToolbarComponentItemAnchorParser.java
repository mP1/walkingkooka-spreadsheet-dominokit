 ...
 */
final class ToolbarComponentItemAnchorParser extends ToolbarComponentItemAnchor<ToolbarComponentItemAnchorParser>
    implements SpreadsheetCellComponentLifecycle,
    NopComponentLifecycleRefresh,
    NopComponentLifecycleOpenGiveFocus {

    static ToolbarComponentItemAnchorParser with(final ToolbarComponentContext context) {
        return new ToolbarComponentItemAnchorParser(context);
    }
