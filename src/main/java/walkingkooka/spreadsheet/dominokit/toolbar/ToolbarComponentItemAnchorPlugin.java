...
final class ToolbarComponentItemAnchorPlugin extends ToolbarComponentItemAnchor<ToolbarComponentItemAnchorPlugin>
    implements NopComponentLifecycleOpenGiveFocus,
    NopComponentLifecycleRefresh {

    static ToolbarComponentItemAnchorPlugin with(final ToolbarComponentContext context) {
        return new ToolbarComponentItemAnchorPlugin(context);
    }
