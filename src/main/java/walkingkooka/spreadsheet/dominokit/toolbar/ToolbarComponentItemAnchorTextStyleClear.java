 ...
 */
final class ToolbarComponentItemAnchorTextStyleClear extends ToolbarComponentItemAnchorTextStyle<ToolbarComponentItemAnchorTextStyleClear> {

    static ToolbarComponentItemAnchorTextStyleClear with(final ToolbarComponentContext context) {
        return new ToolbarComponentItemAnchorTextStyleClear(context);
    }

    private ToolbarComponentItemAnchorTextStyleClear(final ToolbarComponentContext context) {
        super(
            ToolbarComponent.id(
                PROPERTY,
                Optional.empty()
