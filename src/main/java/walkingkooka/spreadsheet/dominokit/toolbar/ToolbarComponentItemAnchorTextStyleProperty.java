 ...
 */
final class ToolbarComponentItemAnchorTextStyleProperty<T> extends ToolbarComponentItemAnchorTextStyle<ToolbarComponentItemAnchorTextStyleProperty<T>> {

    static <T> ToolbarComponentItemAnchorTextStyleProperty<T> with(final TextStylePropertyName<T> propertyName,
        ...
        return new ToolbarComponentItemAnchorTextStyleProperty<>(
            propertyName,
            propertyValue,
            icon,
            text,
    ...
    private ToolbarComponentItemAnchorTextStyleProperty(final TextStylePropertyName<T> propertyName,
                                                        final T propertyValue,
                                                        final Optional<Icon<?>> icon,
                                                        final String text,
                                                        final String tooltipText,
