...
final class BasicSpreadsheetPatternComponentSampleRowProviderContext implements SpreadsheetPatternComponentSampleRowProviderContext {

    static BasicSpreadsheetPatternComponentSampleRowProviderContext with(final SpreadsheetPatternKind kind,
        ...
        return new BasicSpreadsheetPatternComponentSampleRowProviderContext(
                kind,
    ...
    private BasicSpreadsheetPatternComponentSampleRowProviderContext(final SpreadsheetPatternKind kind,
                                                                     final SpreadsheetFormatterContext spreadsheetFormatterContext,
                                                                     final LoggingContext loggingContext) {
        this.kind = kind;
