...
final class BasicSpreadsheetPatternComponentTableComponentRowProviderContext implements SpreadsheetPatternComponentTableComponentRowProviderContext {

    static BasicSpreadsheetPatternComponentTableComponentRowProviderContext with(final SpreadsheetPatternKind kind,
        ...
        return new BasicSpreadsheetPatternComponentTableComponentRowProviderContext(
                kind,
    ...
    private BasicSpreadsheetPatternComponentTableComponentRowProviderContext(final SpreadsheetPatternKind kind,
                                                                             final SpreadsheetFormatterContext spreadsheetFormatterContext,
                                                                             final LoggingContext loggingContext) {
        this.kind = kind;
