...
abstract class SpreadsheetPatternComponentTableComponentRowProviderTime extends SpreadsheetPatternComponentTableComponentRowProvider {

    SpreadsheetPatternComponentTableComponentRowProviderTime() {
        super();
    }
    ...
    private List<SpreadsheetPatternComponentTableComponentRow> timeFormats(final String label,
