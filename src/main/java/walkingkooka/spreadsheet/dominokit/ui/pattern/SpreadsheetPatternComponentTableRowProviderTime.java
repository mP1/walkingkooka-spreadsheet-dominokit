...
abstract class SpreadsheetPatternComponentTableRowProviderTime extends SpreadsheetPatternComponentTableRowProvider {

    SpreadsheetPatternComponentTableRowProviderTime() {
        super();
    }
    ...
    private List<SpreadsheetPatternComponentTableRow> timeFormats(final String label,
