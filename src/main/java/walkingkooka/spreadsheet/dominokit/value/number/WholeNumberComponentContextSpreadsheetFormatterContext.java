...
/**
 * A {@link SpreadsheetFormatterContext} used to formatter a {@link ExpressionNumber} into a {@link String}.
...
final class WholeNumberComponentContextSpreadsheetFormatterContext implements SpreadsheetFormatterContext,
    ...
    static WholeNumberComponentContextSpreadsheetFormatterContext with(final WholeNumberComponentContext context) {
        return new WholeNumberComponentContextSpreadsheetFormatterContext(context);
    }

    private WholeNumberComponentContextSpreadsheetFormatterContext(final WholeNumberComponentContext context) {
    ...
    @Override
    public Optional<Color> colorName(final SpreadsheetColorName spreadsheetColorName) {
        throw new UnsupportedOperationException();
    }
