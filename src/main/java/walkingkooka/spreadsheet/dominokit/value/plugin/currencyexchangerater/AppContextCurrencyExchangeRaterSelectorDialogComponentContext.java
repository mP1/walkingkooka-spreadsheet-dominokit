...
abstract class AppContextCurrencyExchangeRaterSelectorDialogComponentContext implements CurrencyExchangeRaterSelectorDialogComponentContext,
    DialogComponentContextDelegator,
    ComponentLifecycleMatcher {

    AppContextCurrencyExchangeRaterSelectorDialogComponentContext(final AppContext context) {
        super();
    ...
    @Override
    public final SpreadsheetViewportCache spreadsheetViewportCache() {
