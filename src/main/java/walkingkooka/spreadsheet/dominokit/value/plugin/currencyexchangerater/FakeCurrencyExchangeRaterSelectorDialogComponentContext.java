...
public class FakeCurrencyExchangeRaterSelectorDialogComponentContext extends FakeDialogComponentContext implements CurrencyExchangeRaterSelectorDialogComponentContext {

    public FakeCurrencyExchangeRaterSelectorDialogComponentContext() {
        super();
    }
