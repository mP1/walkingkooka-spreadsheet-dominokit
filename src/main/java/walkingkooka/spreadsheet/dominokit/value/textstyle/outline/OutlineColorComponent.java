...
public final class OutlineColorComponent implements TextStylePropertyColorComponentDelegator<OutlineColorComponent> {

    public static OutlineColorComponent with(final String idPrefix,
                                             final OutlineColorComponentContext context) {
        return new OutlineColorComponent(
            idPrefix,
            context
        );
    }

    private OutlineColorComponent(final String idPrefix,
                                  final OutlineColorComponentContext context) {
        super();
        ...
        this.component = TextStylePropertyColorComponent.with(
            ...
            context // OutlineColorComponentContext
        );
    }
