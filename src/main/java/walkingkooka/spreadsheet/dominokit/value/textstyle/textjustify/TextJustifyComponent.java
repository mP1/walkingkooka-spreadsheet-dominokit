...
public final class TextJustifyComponent implements TextStylePropertyEnumComponentDelegator<TextJustify, TextJustifyComponent> {
    ...
    private final TextStylePropertyEnumComponent<TextJustify> component;
