...
public final class TextWrappingComponent implements TextStylePropertyEnumComponentDelegator<TextWrapping, TextWrappingComponent> {
    ...
    private final TextStylePropertyEnumComponent<TextWrapping> component;
