...
public final class WordWrapComponent implements TextStylePropertyEnumComponentDelegator<WordWrap, WordWrapComponent> {
    ...
    private final TextStylePropertyEnumComponent<WordWrap> component;
