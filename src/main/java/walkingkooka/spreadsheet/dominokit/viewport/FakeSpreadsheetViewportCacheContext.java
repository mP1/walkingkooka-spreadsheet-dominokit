...
public class FakeSpreadsheetViewportCacheContext extends FakeRefreshContext implements SpreadsheetViewportCacheContext {

    public FakeSpreadsheetViewportCacheContext() {
        super();
    }
