...
public final class BorderBoxEdgeComponentTest implements ValueTextBoxComponentLikeTesting<BorderBoxEdgeComponent, Border> {
    ...
    public void testClearValue() {
        this.treePrintAndCheck(
            BorderBoxEdgeComponent.empty(BOX_EDGE)
                .clearValue(),
            "BorderBoxEdgeComponent\n" +
                "  TOP\n" +
    ...
    public void testSetValueAll() {
        ...
        this.treePrintAndCheck(
            BorderBoxEdgeComponent.empty(boxEdge)
                .setValue(
                    Optional.of(
    ...
    public void testSetStringValueAll() {
        this.treePrintAndCheck(
            BorderBoxEdgeComponent.empty(BoxEdge.ALL)
                .setStringValue(
                    Optional.of(
    ...
    @Override
    public BorderBoxEdgeComponent createComponent() {
        return BorderBoxEdgeComponent.empty(BOX_EDGE);
    }

    // class............................................................................................................

    @Override
    public Class<BorderBoxEdgeComponent> type() {
        return BorderBoxEdgeComponent.class;
    }
