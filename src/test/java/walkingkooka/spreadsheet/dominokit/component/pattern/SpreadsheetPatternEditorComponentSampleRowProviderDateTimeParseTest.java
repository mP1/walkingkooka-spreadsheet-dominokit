...
public final class SpreadsheetPatternEditorComponentSampleRowProviderDateTimeParseTest extends SpreadsheetPatternEditorComponentSampleRowProviderTestCase<SpreadsheetPatternEditorComponentSampleRowProviderDateTimeParse> {
    ...
    @Override
    SpreadsheetPatternEditorComponentSampleRowProviderDateTimeParse createProvider() {
        return SpreadsheetPatternEditorComponentSampleRowProviderDateTimeParse.INSTANCE;
    }

    @Override
    public Class<SpreadsheetPatternEditorComponentSampleRowProviderDateTimeParse> type() {
        return SpreadsheetPatternEditorComponentSampleRowProviderDateTimeParse.class;
    }
}
