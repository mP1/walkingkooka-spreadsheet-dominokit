...
public final class SpreadsheetPatternEditorComponentSampleRowProviderTimeParseTest extends SpreadsheetPatternEditorComponentSampleRowProviderTestCase<SpreadsheetPatternEditorComponentSampleRowProviderTimeParse> {
    ...
    @Override
    SpreadsheetPatternEditorComponentSampleRowProviderTimeParse createProvider() {
        return SpreadsheetPatternEditorComponentSampleRowProviderTimeParse.INSTANCE;
    }

    @Override
    public Class<SpreadsheetPatternEditorComponentSampleRowProviderTimeParse> type() {
        return SpreadsheetPatternEditorComponentSampleRowProviderTimeParse.class;
    }
}
