                ...
                .setValue(
                    Optional.of(
                        SpreadsheetErrorKind.ERROR.setMessage(
                            "End of text at (5,1) expected LAMBDA_FUNCTION | NAMED_FUNCTION | LABEL | CELL, [WHITESPACE], \":\", [WHITESPACE], CELL | CELL | GROUP | NEGATIVE | \"#.#E+#;#.#%;#.#;#%;#\" | TEXT | \"#NULL!\" | \"#DIV/0!\" | \"#VALUE!\" | \"#REF!\" | \"#NAME?\" | \"#NAME?\" | \"#NUM!\" | \"#N/A\" | \"#ERROR\" | \"#SPILL!\" | \"#CALC!\""
                        )
                    )
                )
        );
