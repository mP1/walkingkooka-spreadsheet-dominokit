...
public final class SpreadsheetCellClipboardPasteHistoryTokenTest extends SpreadsheetCellClipboardHistoryTokenTestCase<SpreadsheetCellClipboardPasteHistoryToken> {
    ...
    public void testParseUnknownKind() {
        this.parseAndCheck(
            "/1/SpreadsheetName456/cell/A1/paste/?unknown",
    ...
    public void testParseCell() {
        this.parseAndCheck(
            "/1/SpreadsheetName456/cell/A1/paste/cell",
    ...
    public void testParseCell2() {
        this.parseAndCheck(
            "/1/SpreadsheetName456/cell/A1:B2/paste/cell",
            this.createHistoryToken(
                SPREADSHEET_ID,
                SPREADSHEET_NAME,
    ...
    public void testParseFormula() {
        this.parseAndCheck(
            "/1/SpreadsheetName456/cell/A1/paste/formula",
            this.createHistoryToken(
                SPREADSHEET_ID,
                SPREADSHEET_NAME,
                CELL.setDefaultAnchor(),
    ...
    public void testUrlFragmentFormatter() {
        this.urlFragmentAndCheck(
            ...
            "/1/SpreadsheetName456/cell/A1/paste/formatter"
        );
    }
