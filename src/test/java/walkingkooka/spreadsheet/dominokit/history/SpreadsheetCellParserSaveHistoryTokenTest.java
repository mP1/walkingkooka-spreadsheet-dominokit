...
public final class SpreadsheetCellParserSaveHistoryTokenTest extends SpreadsheetCellParserHistoryTokenTestCase<SpreadsheetCellParserSaveHistoryToken> {
    ...
    public void testUrlFragmentCell() {
        this.urlFragmentAndCheck("/1/SpreadsheetName456/cell/A1/parser/save/date yyyy-mm-dd");
    }
    ...
    public void testUrlFragmentCellEmptySave() {
        this.urlFragmentAndCheck(
            ...
            "/1/SpreadsheetName456/cell/A1/parser/save/"
        );
    }
    ...
    public void testUrlFragmentCellRange() {
        this.urlFragmentAndCheck(
            ...
            "/1/SpreadsheetName456/cell/B2:C3/top-left/parser/save/date yyyy-mm-dd"
        );
    }
    ...
    public void testUrlFragmentCellRangeStar() {
        this.urlFragmentAndCheck(
            ...
            "/1/SpreadsheetName456/cell/*/top-left/parser/save/date yyyy-mm-dd"
        );
    }
    ...
    public void testUrlFragmentLabel() {
        this.urlFragmentAndCheck(
            LABEL,
            "/1/SpreadsheetName456/cell/Label123/parser/save/date yyyy-mm-dd"
        );
    }
