...
public final class SpreadsheetCellUnfreezeHistoryTokenTest extends SpreadsheetCellHistoryTokenTestCase<SpreadsheetCellUnfreezeHistoryToken> {
    ...
    @Override
    SpreadsheetCellUnfreezeHistoryToken createHistoryHashToken(final SpreadsheetId id,
    ...
    @Override
    public Class<SpreadsheetCellUnfreezeHistoryToken> type() {
        return SpreadsheetCellUnfreezeHistoryToken.class;
    }
}
