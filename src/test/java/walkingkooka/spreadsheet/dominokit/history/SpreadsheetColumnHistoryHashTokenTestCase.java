...
public abstract class SpreadsheetColumnHistoryHashTokenTestCase<T extends SpreadsheetColumnHistoryHashToken> extends SpreadsheetViewportSelectionHistoryHashTokenTestCase<T> {
    ...
    SpreadsheetColumnHistoryHashTokenTestCase() {
        super();
    }
