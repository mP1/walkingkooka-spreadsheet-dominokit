...
public final class SpreadsheetSelectHistoryTokenTest extends SpreadsheetIdHistoryTokenTestCase<SpreadsheetSelectHistoryToken> {
    ...
    @Override
    SpreadsheetSelectHistoryToken createHistoryHashToken() {
