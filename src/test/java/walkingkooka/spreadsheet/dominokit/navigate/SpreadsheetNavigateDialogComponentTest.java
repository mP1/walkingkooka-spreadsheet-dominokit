    ...
    public void testOnHistoryTokenWithSpreadsheetSelect() {
        ...
        this.onHistoryTokenChangeAndCheck(
            ...
            "SpreadsheetNavigateDialogComponent\n" +
                ...
                "          TextBoxComponent\n" +
                "            [] icons=mdi-close-circle id=navigate-home-TextBox REQUIRED\n" +
                "            Errors\n" +
    ...
    public void testOnHistoryTokenWithSpreadsheetNavigate() {
        ...
        this.onHistoryTokenChangeAndCheck(
            ...
            "SpreadsheetNavigateDialogComponent\n" +
                ...
                "          ROW\n" +
                "            \"Save\" DISABLED id=navigate-save-Link\n" +
                "            \"Undo\" [#/123/SpreadsheetName456/navigate/A1] id=navigate-undo-Link\n" +
                "            \"Close\" [#/123/SpreadsheetName456] id=navigate-close-Link\n"
        );
    }
    ...
    public void testOnHistoryTokenWithSpreadsheetCellNavigate() {
        ...
        this.onHistoryTokenChangeAndCheck(
            ...
            "SpreadsheetNavigateDialogComponent\n" +
                ...
                "          ROW\n" +
                "            \"Save\" DISABLED id=navigate-save-Link\n" +
                "            \"Undo\" [#/123/SpreadsheetName456/cell/B2/navigate/A1] id=navigate-undo-Link\n" +
                "            \"Close\" [#/123/SpreadsheetName456/cell/B2] id=navigate-close-Link\n"
        );
    }
    ...
    public void testOnHistoryTokenWithSpreadsheetColumnNavigate() {
        ...
        this.onHistoryTokenChangeAndCheck(
            ...
            "SpreadsheetNavigateDialogComponent\n" +
                ...
                "          ROW\n" +
                "            \"Save\" DISABLED id=navigate-save-Link\n" +
                "            \"Undo\" [#/123/SpreadsheetName456/column/C/navigate/A1] id=navigate-undo-Link\n" +
                "            \"Close\" [#/123/SpreadsheetName456/column/C] id=navigate-close-Link\n"
        );
    }
    ...
    public void testOnHistoryTokenWithSpreadsheetRowNavigate() {
        ...
        this.onHistoryTokenChangeAndCheck(
            ...
            "SpreadsheetNavigateDialogComponent\n" +
                ...
                "          ROW\n" +
                "            \"Save\" DISABLED id=navigate-save-Link\n" +
                "            \"Undo\" [#/123/SpreadsheetName456/row/99/navigate/A1] id=navigate-undo-Link\n" +
                "            \"Close\" [#/123/SpreadsheetName456/row/99] id=navigate-close-Link\n"
        );
    }
