...
public final class SpreadsheetPatternEditorComponentSampleRowProviderDateTimeFormatTest extends SpreadsheetPatternEditorComponentSampleRowProviderTestCase<SpreadsheetPatternEditorComponentSampleRowProviderDateTimeFormat> {
    ...
    @Override
    SpreadsheetPatternEditorComponentSampleRowProviderDateTimeFormat createProvider() {
        return SpreadsheetPatternEditorComponentSampleRowProviderDateTimeFormat.INSTANCE;
    }

    @Override
    public Class<SpreadsheetPatternEditorComponentSampleRowProviderDateTimeFormat> type() {
        return SpreadsheetPatternEditorComponentSampleRowProviderDateTimeFormat.class;
    }
}
