...
public abstract class SpreadsheetPatternEditorComponentSampleRowProviderTestCase<T extends SpreadsheetPatternEditorComponentSampleRowProvider> implements
        BiFunctionTesting<T, String, SpreadsheetPatternEditorComponentSampleRowProviderContext, List<SpreadsheetPatternEditorComponentSampleRow>>,
        ClassTesting<T>,
        ToStringTesting<T>,
    ...
    final void applyAndCheckFirst(final String patternText,
                                  ...
                                  final SpreadsheetPatternEditorComponentSampleRow expected) {
        this.applyAndCheck(
                patternText,
                context,
                Lists.of(expected)
