...
public final class SpreadsheetPatternEditorComponentTest implements ClassTesting<SpreadsheetPatternEditorComponent> {
    ...
    private void spreadsheetPatternKindIdAndCheck(final SpreadsheetPatternKind kind,
        ...
        this.checkEquals(
                expected,
                SpreadsheetPatternEditorComponent.spreadsheetPatternKindId(kind),
    ...
    @Override
    public Class<SpreadsheetPatternEditorComponent> type() {
        return SpreadsheetPatternEditorComponent.class;
    }
