...
public final class SpreadsheetPatternEditorWidgetSampleRowProviderContextTest implements ContextTesting<SpreadsheetPatternEditorWidgetSampleRowProviderContext> {
    ...
    @Override
    public SpreadsheetPatternEditorWidgetSampleRowProviderContext createContext() {
    ...
    @Override
    public Class<SpreadsheetPatternEditorWidgetSampleRowProviderContext> type() {
        return SpreadsheetPatternEditorWidgetSampleRowProviderContext.class;
    }
