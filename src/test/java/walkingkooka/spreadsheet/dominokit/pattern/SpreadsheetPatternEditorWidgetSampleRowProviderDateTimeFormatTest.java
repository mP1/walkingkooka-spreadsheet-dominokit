...
public final class SpreadsheetPatternEditorWidgetSampleRowProviderDateTimeFormatTest extends SpreadsheetPatternEditorWidgetSampleRowProviderTestCase<SpreadsheetPatternEditorWidgetSampleRowProviderDateTimeFormat> {
    ...
    @Override
    SpreadsheetPatternEditorWidgetSampleRowProviderDateTimeFormat createProvider() {
        return SpreadsheetPatternEditorWidgetSampleRowProviderDateTimeFormat.INSTANCE;
    }

    @Override
    public Class<SpreadsheetPatternEditorWidgetSampleRowProviderDateTimeFormat> type() {
        return SpreadsheetPatternEditorWidgetSampleRowProviderDateTimeFormat.class;
    }
}
