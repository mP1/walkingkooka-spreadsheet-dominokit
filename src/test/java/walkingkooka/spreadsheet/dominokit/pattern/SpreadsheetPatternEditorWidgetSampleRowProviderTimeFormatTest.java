...
public final class SpreadsheetPatternEditorWidgetSampleRowProviderTimeFormatTest extends SpreadsheetPatternEditorWidgetSampleRowProviderTestCase<SpreadsheetPatternEditorWidgetSampleRowProviderTimeFormat> {
    ...
    @Override
    SpreadsheetPatternEditorWidgetSampleRowProviderTimeFormat createProvider() {
        return SpreadsheetPatternEditorWidgetSampleRowProviderTimeFormat.INSTANCE;
    }

    @Override
    public Class<SpreadsheetPatternEditorWidgetSampleRowProviderTimeFormat> type() {
        return SpreadsheetPatternEditorWidgetSampleRowProviderTimeFormat.class;
    }
}
