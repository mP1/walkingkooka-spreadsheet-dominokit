...
public final class SpreadsheetPatternEditorWidgetSampleRowProviderTimeParseTest extends SpreadsheetPatternEditorWidgetSampleRowProviderTestCase<SpreadsheetPatternEditorWidgetSampleRowProviderTimeParse> {
    ...
    @Override
    SpreadsheetPatternEditorWidgetSampleRowProviderTimeParse createProvider() {
        return SpreadsheetPatternEditorWidgetSampleRowProviderTimeParse.INSTANCE;
    }

    @Override
    public Class<SpreadsheetPatternEditorWidgetSampleRowProviderTimeParse> type() {
        return SpreadsheetPatternEditorWidgetSampleRowProviderTimeParse.class;
    }
}
