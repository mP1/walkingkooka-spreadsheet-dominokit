...
public final class SpreadsheetPatternEditorWidgetTest implements ClassTesting<SpreadsheetPatternEditorWidget> {
    ...
    private void spreadsheetPatternKindIdAndCheck(final SpreadsheetPatternKind kind,
        ...
        this.checkEquals(
                expected,
                SpreadsheetPatternEditorWidget.spreadsheetPatternKindId(kind),
    ...
    @Override
    public Class<SpreadsheetPatternEditorWidget> type() {
        return SpreadsheetPatternEditorWidget.class;
    }
