...
public final class ToolbarComponentTest implements HistoryTokenAwareComponentLifecycleTesting<ToolbarComponent>,
    ...
    private ToolbarComponent createComponent(final AppContext context) {
        return ToolbarComponent.with(
    ...
    @Override
    public Class<ToolbarComponent> type() {
        return ToolbarComponent.class;
    }
