...
public final class BasicSpreadsheetPatternComponentTableComponentRowProviderContextTest implements ClassTesting<BasicSpreadsheetPatternComponentTableComponentRowProviderContext>,
        ToStringTesting<BasicSpreadsheetPatternComponentTableComponentRowProviderContext> {
    ...
    private void withFails(final SpreadsheetPatternKind kind,
        ...
        assertThrows(
                ...
                () -> BasicSpreadsheetPatternComponentTableComponentRowProviderContext.with(
                        kind,
    ...
    public void testWith() {
        ...
        final BasicSpreadsheetPatternComponentTableComponentRowProviderContext context = BasicSpreadsheetPatternComponentTableComponentRowProviderContext.with(
                kind,
                spreadsheetFormatterContext,
                LoggingContexts.fake()
        );
    ...
    @Override
    public Class<BasicSpreadsheetPatternComponentTableComponentRowProviderContext> type() {
        return BasicSpreadsheetPatternComponentTableComponentRowProviderContext.class;
    }
