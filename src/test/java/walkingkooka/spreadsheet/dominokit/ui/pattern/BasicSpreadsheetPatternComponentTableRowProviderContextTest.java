...
public final class BasicSpreadsheetPatternComponentTableRowProviderContextTest implements ClassTesting<BasicSpreadsheetPatternComponentTableRowProviderContext>,
        ToStringTesting<BasicSpreadsheetPatternComponentTableRowProviderContext> {
    ...
    private void withFails(final SpreadsheetPatternKind kind,
        ...
        assertThrows(
                ...
                () -> BasicSpreadsheetPatternComponentTableRowProviderContext.with(
                        kind,
    ...
    public void testWith() {
        ...
        final BasicSpreadsheetPatternComponentTableRowProviderContext context = BasicSpreadsheetPatternComponentTableRowProviderContext.with(
                kind,
                spreadsheetFormatterContext,
                LoggingContexts.fake()
        );
    ...
    @Override
    public Class<BasicSpreadsheetPatternComponentTableRowProviderContext> type() {
        return BasicSpreadsheetPatternComponentTableRowProviderContext.class;
    }
