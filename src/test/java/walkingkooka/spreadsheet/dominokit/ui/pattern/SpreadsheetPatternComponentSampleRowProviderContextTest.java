...
public final class SpreadsheetPatternComponentSampleRowProviderContextTest implements ContextTesting<SpreadsheetPatternComponentSampleRowProviderContext> {
    ...
    public void testDefaultFormat2() {
        ...
        this.checkEquals(
                ...
                new FakeSpreadsheetPatternComponentSampleRowProviderContext() {
                    @Override
    ...
    @Override
    public SpreadsheetPatternComponentSampleRowProviderContext createContext() {
    ...
    @Override
    public Class<SpreadsheetPatternComponentSampleRowProviderContext> type() {
        return SpreadsheetPatternComponentSampleRowProviderContext.class;
    }
