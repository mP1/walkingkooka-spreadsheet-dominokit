...
public final class SpreadsheetPatternComponentSampleRowProviderDateFormatTest extends SpreadsheetPatternComponentSampleRowProviderTestCase<SpreadsheetPatternComponentSampleRowProviderDateFormat> {
    ...
    @Override
    SpreadsheetPatternComponentSampleRowProviderDateFormat createProvider() {
        return SpreadsheetPatternComponentSampleRowProviderDateFormat.INSTANCE;
    }

    @Override
    public Class<SpreadsheetPatternComponentSampleRowProviderDateFormat> type() {
        return SpreadsheetPatternComponentSampleRowProviderDateFormat.class;
    }
}
