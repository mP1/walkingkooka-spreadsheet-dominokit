...
public final class SpreadsheetPatternComponentSampleRowProviderDateParseTest extends SpreadsheetPatternComponentSampleRowProviderTestCase<SpreadsheetPatternComponentSampleRowProviderDateParse> {
    ...
    @Override
    SpreadsheetPatternComponentSampleRowProviderDateParse createProvider() {
        return SpreadsheetPatternComponentSampleRowProviderDateParse.INSTANCE;
    }

    @Override
    public Class<SpreadsheetPatternComponentSampleRowProviderDateParse> type() {
        return SpreadsheetPatternComponentSampleRowProviderDateParse.class;
    }
}
