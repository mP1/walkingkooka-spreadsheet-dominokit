...
public final class SpreadsheetPatternComponentSampleRowProviderDateTimeFormatTest extends SpreadsheetPatternComponentSampleRowProviderTestCase<SpreadsheetPatternComponentSampleRowProviderDateTimeFormat> {
    ...
    @Override
    SpreadsheetPatternComponentSampleRowProviderDateTimeFormat createProvider() {
        return SpreadsheetPatternComponentSampleRowProviderDateTimeFormat.INSTANCE;
    }

    @Override
    public Class<SpreadsheetPatternComponentSampleRowProviderDateTimeFormat> type() {
        return SpreadsheetPatternComponentSampleRowProviderDateTimeFormat.class;
    }
}
