...
public final class SpreadsheetPatternComponentSampleRowProviderDateTimeParseTest extends SpreadsheetPatternComponentSampleRowProviderTestCase<SpreadsheetPatternComponentSampleRowProviderDateTimeParse> {
    ...
    @Override
    SpreadsheetPatternComponentSampleRowProviderDateTimeParse createProvider() {
        return SpreadsheetPatternComponentSampleRowProviderDateTimeParse.INSTANCE;
    }

    @Override
    public Class<SpreadsheetPatternComponentSampleRowProviderDateTimeParse> type() {
        return SpreadsheetPatternComponentSampleRowProviderDateTimeParse.class;
    }
}
