...
public final class SpreadsheetPatternComponentSampleRowProviderTimeFormatTest extends SpreadsheetPatternComponentSampleRowProviderTestCase<SpreadsheetPatternComponentSampleRowProviderTimeFormat> {
    ...
    @Override
    SpreadsheetPatternComponentSampleRowProviderTimeFormat createProvider() {
        return SpreadsheetPatternComponentSampleRowProviderTimeFormat.INSTANCE;
    }

    @Override
    public Class<SpreadsheetPatternComponentSampleRowProviderTimeFormat> type() {
        return SpreadsheetPatternComponentSampleRowProviderTimeFormat.class;
    }
}
