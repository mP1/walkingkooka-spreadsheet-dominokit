...
public final class SpreadsheetPatternComponentSampleRowProviderTimeParseTest extends SpreadsheetPatternComponentSampleRowProviderTestCase<SpreadsheetPatternComponentSampleRowProviderTimeParse> {
    ...
    @Override
    SpreadsheetPatternComponentSampleRowProviderTimeParse createProvider() {
        return SpreadsheetPatternComponentSampleRowProviderTimeParse.INSTANCE;
    }

    @Override
    public Class<SpreadsheetPatternComponentSampleRowProviderTimeParse> type() {
        return SpreadsheetPatternComponentSampleRowProviderTimeParse.class;
    }
}
