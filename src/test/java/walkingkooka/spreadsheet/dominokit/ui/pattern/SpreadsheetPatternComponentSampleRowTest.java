...
public final class SpreadsheetPatternComponentSampleRowTest implements ClassTesting<SpreadsheetPatternComponentSampleRow>,
        HashCodeEqualsDefinedTesting2<SpreadsheetPatternComponentSampleRow>,
        ToStringTesting<SpreadsheetPatternComponentSampleRow> {
    ...
    @Override
    public SpreadsheetPatternComponentSampleRow createObject() {
    ...
    @Override
    public Class<SpreadsheetPatternComponentSampleRow> type() {
        return SpreadsheetPatternComponentSampleRow.class;
    }
