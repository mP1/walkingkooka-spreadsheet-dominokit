...
public final class SpreadsheetPatternComponentTableComponentRowProviderContextTest implements ContextTesting<SpreadsheetPatternComponentTableComponentRowProviderContext> {
    ...
    public void testDefaultFormat2() {
        ...
        this.checkEquals(
                ...
                new FakeSpreadsheetPatternComponentTableComponentRowProviderContext() {
                    @Override
    ...
    @Override
    public SpreadsheetPatternComponentTableComponentRowProviderContext createContext() {
    ...
    @Override
    public Class<SpreadsheetPatternComponentTableComponentRowProviderContext> type() {
        return SpreadsheetPatternComponentTableComponentRowProviderContext.class;
    }
