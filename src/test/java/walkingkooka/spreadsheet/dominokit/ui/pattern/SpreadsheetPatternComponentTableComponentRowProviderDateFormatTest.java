...
public final class SpreadsheetPatternComponentTableComponentRowProviderDateFormatTest extends SpreadsheetPatternComponentTableComponentRowProviderTestCase<SpreadsheetPatternComponentTableComponentRowProviderDateFormat> {
    ...
    @Override
    SpreadsheetPatternComponentTableComponentRowProviderDateFormat createProvider() {
        return SpreadsheetPatternComponentTableComponentRowProviderDateFormat.INSTANCE;
    }

    @Override
    public Class<SpreadsheetPatternComponentTableComponentRowProviderDateFormat> type() {
        return SpreadsheetPatternComponentTableComponentRowProviderDateFormat.class;
    }
}
