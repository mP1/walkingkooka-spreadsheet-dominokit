...
public final class SpreadsheetPatternComponentTableComponentRowProviderDateParseTest extends SpreadsheetPatternComponentTableComponentRowProviderTestCase<SpreadsheetPatternComponentTableComponentRowProviderDateParse> {
    ...
    public void testValidPatternText2() {
        ...
        this.applyAndCheck2(
                patternText,
                CONTEXT,
                "Edit Pattern | yyyy/dd/mmm | 2023/11/Jul.\n" +
                        "Today Short | d/m/yy | 11/7/23\n" +
                        "Today Medium | d mmm yyyy | 11 Jul. 2023\n" +
                        "Today Long | d mmmm yyyy | 11 July 2023\n" +
                        "Today Full | dddd, d mmmm yyyy | Tuesday, 11 July 2023\n" +
    ...
    @Override
    SpreadsheetPatternComponentTableComponentRowProviderDateParse createProvider() {
        return SpreadsheetPatternComponentTableComponentRowProviderDateParse.INSTANCE;
    }

    @Override
    public Class<SpreadsheetPatternComponentTableComponentRowProviderDateParse> type() {
        return SpreadsheetPatternComponentTableComponentRowProviderDateParse.class;
    }
}
