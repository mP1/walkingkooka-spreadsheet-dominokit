...
public final class SpreadsheetPatternComponentTableComponentRowProviderDateTimeFormatTest extends SpreadsheetPatternComponentTableComponentRowProviderTestCase<SpreadsheetPatternComponentTableComponentRowProviderDateTimeFormat> {
    ...
    public void testValidPatternTextWithColor() {
        ...
        this.applyAndCheck2(
                patternText,
                CONTEXT,
                "Edit Pattern | [RED]yyyy/dd/mmm | 2023/12/Jul.\n" +
                        "Today Short | d/m/yy, h:mm AM/PM | 12/7/23, 12:58 PM\n" +
                        "Today Medium | d mmm yyyy, h:mm:ss AM/PM | 12 Jul. 2023, 12:58:59 PM\n" +
                        "Today Long | d mmmm yyyy \\a\\t h:mm:ss AM/PM | 12 July 2023 at 12:58:59 PM\n" +
                        "Today Full | dddd, d mmmm yyyy \\a\\t h:mm:ss AM/PM | Wednesday, 12 July 2023 at 12:58:59 PM\n" +
    ...
    @Override
    SpreadsheetPatternComponentTableComponentRowProviderDateTimeFormat createProvider() {
        return SpreadsheetPatternComponentTableComponentRowProviderDateTimeFormat.INSTANCE;
    }

    @Override
    public Class<SpreadsheetPatternComponentTableComponentRowProviderDateTimeFormat> type() {
        return SpreadsheetPatternComponentTableComponentRowProviderDateTimeFormat.class;
    }
}
