...
public final class SpreadsheetPatternComponentTableComponentRowProviderDateTimeParseTest extends SpreadsheetPatternComponentTableComponentRowProviderTestCase<SpreadsheetPatternComponentTableComponentRowProviderDateTimeParse> {
    ...
    @Override
    SpreadsheetPatternComponentTableComponentRowProviderDateTimeParse createProvider() {
        return SpreadsheetPatternComponentTableComponentRowProviderDateTimeParse.INSTANCE;
    }

    @Override
    public Class<SpreadsheetPatternComponentTableComponentRowProviderDateTimeParse> type() {
        return SpreadsheetPatternComponentTableComponentRowProviderDateTimeParse.class;
    }
}
