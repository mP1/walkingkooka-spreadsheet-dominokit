...
public final class SpreadsheetPatternComponentTableComponentRowProviderNumberFormatTest extends SpreadsheetPatternComponentTableComponentRowProviderTestCase<SpreadsheetPatternComponentTableComponentRowProviderNumberFormat> {
    ...
    public void testValidPatternTextWithColor() {
        ...
        this.applyAndCheck2(
                patternText,
                CONTEXT,
                "Edit Pattern | [BLUE] #.000 |  1234D560\\r\\n N9876D540\\r\\n D000\n" +
                        "General | General | 1234D56\\r\\nN9876D54\\r\\n0\n" +
                        "Number | #,##0.### | 1G234D56\\r\\nN9G876D54\\r\\n0D\n" +
                        "Integer | #,##0 | 1G235\\r\\nN9G877\\r\\n0\n" +
                        "Percent | #,##0% | 123G456P\\r\\nN987G654P\\r\\n0P\n" +
    ...
    @Override
    SpreadsheetPatternComponentTableComponentRowProviderNumberFormat createProvider() {
        return SpreadsheetPatternComponentTableComponentRowProviderNumberFormat.INSTANCE;
    }

    @Override
    public Class<SpreadsheetPatternComponentTableComponentRowProviderNumberFormat> type() {
        return SpreadsheetPatternComponentTableComponentRowProviderNumberFormat.class;
    }
}
