...
public abstract class SpreadsheetPatternComponentTableComponentRowProviderTestCase<T extends SpreadsheetPatternComponentTableComponentRowProvider> implements
        BiFunctionTesting<T, String, SpreadsheetPatternComponentTableComponentRowProviderContext, List<SpreadsheetPatternComponentTableComponentRow>>,
        ClassTesting<T>,
        ToStringTesting<T>,
    ...
    SpreadsheetPatternComponentTableComponentRowProviderTestCase() {
        super();
    }
    ...
    final void applyAndCheckFirst(final String patternText,
                                  ...
                                  final SpreadsheetPatternComponentTableComponentRow expected) {
        this.applyAndCheck(
                patternText,
                context,
                Lists.of(expected)
