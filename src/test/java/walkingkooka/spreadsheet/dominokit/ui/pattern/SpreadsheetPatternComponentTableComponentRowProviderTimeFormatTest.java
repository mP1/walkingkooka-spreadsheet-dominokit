...
public final class SpreadsheetPatternComponentTableComponentRowProviderTimeFormatTest extends SpreadsheetPatternComponentTableComponentRowProviderTestCase<SpreadsheetPatternComponentTableComponentRowProviderTimeFormat> {
    ...
    @Override
    SpreadsheetPatternComponentTableComponentRowProviderTimeFormat createProvider() {
        return SpreadsheetPatternComponentTableComponentRowProviderTimeFormat.INSTANCE;
    }

    @Override
    public Class<SpreadsheetPatternComponentTableComponentRowProviderTimeFormat> type() {
        return SpreadsheetPatternComponentTableComponentRowProviderTimeFormat.class;
    }
}
