...
public final class SpreadsheetPatternComponentTableRowProviderDateFormatTest extends SpreadsheetPatternComponentTableRowProviderTestCase<SpreadsheetPatternComponentTableRowProviderDateFormat> {
    ...
    @Override
    SpreadsheetPatternComponentTableRowProviderDateFormat createProvider() {
        return SpreadsheetPatternComponentTableRowProviderDateFormat.INSTANCE;
    }

    @Override
    public Class<SpreadsheetPatternComponentTableRowProviderDateFormat> type() {
        return SpreadsheetPatternComponentTableRowProviderDateFormat.class;
    }
}
