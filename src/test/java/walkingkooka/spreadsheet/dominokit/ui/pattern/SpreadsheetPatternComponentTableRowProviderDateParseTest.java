...
public final class SpreadsheetPatternComponentTableRowProviderDateParseTest extends SpreadsheetPatternComponentTableRowProviderTestCase<SpreadsheetPatternComponentTableRowProviderDateParse> {
    ...
    @Override
    SpreadsheetPatternComponentTableRowProviderDateParse createProvider() {
        return SpreadsheetPatternComponentTableRowProviderDateParse.INSTANCE;
    }

    @Override
    public Class<SpreadsheetPatternComponentTableRowProviderDateParse> type() {
        return SpreadsheetPatternComponentTableRowProviderDateParse.class;
    }
}
