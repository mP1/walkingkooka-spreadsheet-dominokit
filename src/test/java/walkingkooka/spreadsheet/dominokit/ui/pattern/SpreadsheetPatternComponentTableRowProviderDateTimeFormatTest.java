...
public final class SpreadsheetPatternComponentTableRowProviderDateTimeFormatTest extends SpreadsheetPatternComponentTableRowProviderTestCase<SpreadsheetPatternComponentTableRowProviderDateTimeFormat> {
    ...
    @Override
    SpreadsheetPatternComponentTableRowProviderDateTimeFormat createProvider() {
        return SpreadsheetPatternComponentTableRowProviderDateTimeFormat.INSTANCE;
    }

    @Override
    public Class<SpreadsheetPatternComponentTableRowProviderDateTimeFormat> type() {
        return SpreadsheetPatternComponentTableRowProviderDateTimeFormat.class;
    }
}
