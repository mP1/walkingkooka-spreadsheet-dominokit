...
public final class SpreadsheetPatternComponentTableRowProviderNumberParseTest extends SpreadsheetPatternComponentTableRowProviderTestCase<SpreadsheetPatternComponentTableRowProviderNumberParse> {
    ...
    @Override
    SpreadsheetPatternComponentTableRowProviderNumberParse createProvider() {
        return SpreadsheetPatternComponentTableRowProviderNumberParse.INSTANCE;
    }

    @Override
    public Class<SpreadsheetPatternComponentTableRowProviderNumberParse> type() {
        return SpreadsheetPatternComponentTableRowProviderNumberParse.class;
    }
}
