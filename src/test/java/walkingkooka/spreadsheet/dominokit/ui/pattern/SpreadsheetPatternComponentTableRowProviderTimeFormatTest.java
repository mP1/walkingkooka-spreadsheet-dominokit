...
public final class SpreadsheetPatternComponentTableRowProviderTimeFormatTest extends SpreadsheetPatternComponentTableRowProviderTestCase<SpreadsheetPatternComponentTableRowProviderTimeFormat> {
    ...
    @Override
    SpreadsheetPatternComponentTableRowProviderTimeFormat createProvider() {
        return SpreadsheetPatternComponentTableRowProviderTimeFormat.INSTANCE;
    }

    @Override
    public Class<SpreadsheetPatternComponentTableRowProviderTimeFormat> type() {
        return SpreadsheetPatternComponentTableRowProviderTimeFormat.class;
    }
}
