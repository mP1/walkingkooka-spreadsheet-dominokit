...
public final class SpreadsheetPatternComponentTableRowProviderTimeParseTest extends SpreadsheetPatternComponentTableRowProviderTestCase<SpreadsheetPatternComponentTableRowProviderTimeParse> {
    ...
    @Override
    SpreadsheetPatternComponentTableRowProviderTimeParse createProvider() {
        return SpreadsheetPatternComponentTableRowProviderTimeParse.INSTANCE;
    }

    @Override
    public Class<SpreadsheetPatternComponentTableRowProviderTimeParse> type() {
        return SpreadsheetPatternComponentTableRowProviderTimeParse.class;
    }
}
