...
public final class SpreadsheetPatternEditorComponentSampleRowProviderDateParseTest extends SpreadsheetPatternEditorComponentSampleRowProviderTestCase<SpreadsheetPatternEditorComponentSampleRowProviderDateParse> {
    ...
    @Override
    SpreadsheetPatternEditorComponentSampleRowProviderDateParse createProvider() {
        return SpreadsheetPatternEditorComponentSampleRowProviderDateParse.INSTANCE;
    }

    @Override
    public Class<SpreadsheetPatternEditorComponentSampleRowProviderDateParse> type() {
        return SpreadsheetPatternEditorComponentSampleRowProviderDateParse.class;
    }
}
