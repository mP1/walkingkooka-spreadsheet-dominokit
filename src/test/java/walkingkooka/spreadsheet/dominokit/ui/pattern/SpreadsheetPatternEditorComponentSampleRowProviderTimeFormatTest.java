...
public final class SpreadsheetPatternEditorComponentSampleRowProviderTimeFormatTest extends SpreadsheetPatternEditorComponentSampleRowProviderTestCase<SpreadsheetPatternEditorComponentSampleRowProviderTimeFormat> {
    ...
    @Override
    SpreadsheetPatternEditorComponentSampleRowProviderTimeFormat createProvider() {
        return SpreadsheetPatternEditorComponentSampleRowProviderTimeFormat.INSTANCE;
    }

    @Override
    public Class<SpreadsheetPatternEditorComponentSampleRowProviderTimeFormat> type() {
        return SpreadsheetPatternEditorComponentSampleRowProviderTimeFormat.class;
    }
}
