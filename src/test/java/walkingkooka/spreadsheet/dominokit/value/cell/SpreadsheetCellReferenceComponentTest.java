    ...
    public void testClearValue() {
        this.treePrintAndCheck(
            ...
            "SpreadsheetCellReferenceComponent\n" +
                ...
                "    TextBoxComponent\n" +
                "      [] icons=mdi-close-circle id=cell-id REQUIRED\n" +
                "      Errors\n" +
    ...
    public void testSetValue() {
        this.treePrintAndCheck(
            ...
            "SpreadsheetCellReferenceComponent\n" +
                "  ValueTextBoxComponent\n" +
                "    TextBoxComponent\n" +
                "      [A1] icons=mdi-close-circle id=cell-id REQUIRED\n"
        );
    }
    ...
    public void testSetStringValueWithInvalid() {
        this.treePrintAndCheck(
            ...
            "SpreadsheetCellReferenceComponent\n" +
                "  ValueTextBoxComponent\n" +
                "    TextBoxComponent\n" +
                "      [!invalid] icons=mdi-close-circle id=cell-id REQUIRED\n" +
                "      Errors\n" +
    ...
    public void testSetStringValueWithCellRange() {
        this.treePrintAndCheck(
            ...
            "SpreadsheetCellReferenceComponent\n" +
                "  ValueTextBoxComponent\n" +
                "    TextBoxComponent\n" +
                "      [B2:C3] icons=mdi-close-circle id=cell-id REQUIRED\n" +
                "      Errors\n" +
    ...
    public void testSetStringValueWithCell() {
        this.treePrintAndCheck(
            ...
            "SpreadsheetCellReferenceComponent\n" +
                "  ValueTextBoxComponent\n" +
                "    TextBoxComponent\n" +
                "      [C3] icons=mdi-close-circle id=cell-id REQUIRED\n"
        );
    }
    ...
    public void testSetStringValueWithAbsoluteMixedCaseCell() {
        this.treePrintAndCheck(
            ...
            "SpreadsheetCellReferenceComponent\n" +
                "  ValueTextBoxComponent\n" +
                "    TextBoxComponent\n" +
                "      [$D4] icons=mdi-close-circle id=cell-id REQUIRED\n"
        );
    }
