...
import walkingkooka.spreadsheet.dominokit.value.datetime.DateComponentContext;
import walkingkooka.spreadsheet.dominokit.value.datetime.DateTimeComponent;
import walkingkooka.spreadsheet.dominokit.value.datetime.FakeDateComponentContext;
...
public final class SpreadsheetCellValueDialogComponentTest implements DialogComponentLifecycleTesting<SpreadsheetCellValueDialogComponent<LocalDate>>,
    ...
    public void testOnHistoryTokenChangeWithSpreadsheetCellValueHistoryTokenAndUrlValue() {
        final HistoryToken historyToken = HistoryToken.parseString(
            "/123/SpreadsheetName456/cell/A1/value/url"
        );
        ...
        this.onHistoryTokenChangeAndCheck(
            ...
            "SpreadsheetCellValueDialogComponent\n" +
                ...
                "          FlexLayoutComponent\n" +
                "            ROW\n" +
                "              \"Save\" [#/123/SpreadsheetName456/cell/A1/value/url/save/%22https://example.com/path1/k1%253Dv2%22] id=Test123-save-Link\n" +
                "              \"Clear\" [#/123/SpreadsheetName456/cell/A1/value/url/save/] id=Test123-clear-Link\n" +
                "              \"Undo\" [#/123/SpreadsheetName456/cell/A1/value/url/save/%22https://example.com/path1/k1%253Dv2%22] id=Test123-undo-Link\n" +
                "              \"Close\" [#/123/SpreadsheetName456/cell/A1] id=Test123-close-Link\n"
        );
    }
    ...
    static class TestSpreadsheetCellValueDialogComponentContext<T> extends FakeSpreadsheetCellValueDialogComponentContext<T> {
        ...
        TestSpreadsheetCellValueDialogComponentContext(final ValueType valueType,
