    ...
    public void testTreePrintWithConditionTest() {
        this.treePrintAndCheck(
            ...
            "SpreadsheetFormulaParserTokenComponent\n" +
                "  ValueTextBoxComponent\n" +
                "    TextBoxComponent\n" +
                "      [>3] icons=mdi-close-circle REQUIRED\n"
        );
    }
    ...
    public void testTreePrintWithNumber() {
        this.treePrintAndCheck(
            ...
            "SpreadsheetFormulaParserTokenComponent\n" +
                "  ValueTextBoxComponent\n" +
                "    TextBoxComponent\n" +
                "      [=123.0] icons=mdi-close-circle REQUIRED\n"
        );
    }
    ...
    public void testTreePrintWithDate() {
        this.treePrintAndCheck(
            ...
            "SpreadsheetFormulaParserTokenComponent\n" +
                "  ValueTextBoxComponent\n" +
                "    TextBoxComponent\n" +
                "      [=1999/12/31] icons=mdi-close-circle REQUIRED\n"
        );
    }
    ...
    public void testTreePrintWithDateTime() {
        this.treePrintAndCheck(
            ...
            "SpreadsheetFormulaParserTokenComponent\n" +
                "  ValueTextBoxComponent\n" +
                "    TextBoxComponent\n" +
                "      [=1999/12/31 12:58] icons=mdi-close-circle REQUIRED\n"
        );
    }
    ...
    public void testTreePrintWithTime() {
        this.treePrintAndCheck(
            ...
            "SpreadsheetFormulaParserTokenComponent\n" +
                "  ValueTextBoxComponent\n" +
                "    TextBoxComponent\n" +
                "      [=12:58:59] icons=mdi-close-circle REQUIRED\n"
        );
    }
    ...
    public void testTreePrintWithInvalidExpression() {
        this.treePrintAndCheck(
            ...
            "SpreadsheetFormulaParserTokenComponent\n" +
                "  ValueTextBoxComponent\n" +
                "    TextBoxComponent\n" +
                "      [=1.25+] icons=mdi-close-circle REQUIRED\n" +
                "      Errors\n" +
