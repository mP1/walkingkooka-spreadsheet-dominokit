    ...
    public void testOnHistoryTokenChangeSpreadsheetLabelMappingCreateHistoryToken() {
        this.onHistoryTokenChangeAndCheck(
            ...
            "SpreadsheetLabelMappingDialogComponent\n" +
                ...
                "        SuggestBoxComponent\n" +
                "          Label [] id=SpreadsheetLabelMapping-label-TextBox REQUIRED\n" +
                "          Errors\n" +
                "            Required\n" +
                "      SpreadsheetExpressionReferenceComponent\n" +
                "        ValueTextBoxComponent\n" +
                "          TextBoxComponent\n" +
                "            Cell, cell range or Label [] icons=mdi-close-circle id=SpreadsheetLabelMapping-reference-TextBox REQUIRED\n" +
                "            Errors\n" +
                "              Empty \"text\"\n" +
                "      AnchorListComponent\n" +
                "        FlexLayoutComponent\n" +
    ...
    public void testOnHistoryTokenChangeSpreadsheetLabelMappingSelectHistoryTokenWithCell() {
        this.onHistoryTokenChangeAndCheck(
            ...
            "SpreadsheetLabelMappingDialogComponent\n" +
                ...
                "        ValueTextBoxComponent\n" +
                "          TextBoxComponent\n" +
                "            Cell, cell range or Label [A1] icons=mdi-close-circle id=SpreadsheetLabelMapping-reference-TextBox REQUIRED\n" +
                "      AnchorListComponent\n" +
                "        FlexLayoutComponent\n" +
                "          ROW\n" +
                "            \"Save\" DISABLED id=SpreadsheetLabelMapping-save-Link\n" +
    ...
    public void testOnHistoryTokenChangeSpreadsheetLabelMappingSelectHistoryTokenWIthCellRange() {
        this.onHistoryTokenChangeAndCheck(
            ...
            "SpreadsheetLabelMappingDialogComponent\n" +
                ...
                "        ValueTextBoxComponent\n" +
                "          TextBoxComponent\n" +
                "            Cell, cell range or Label [B2:C3] icons=mdi-close-circle id=SpreadsheetLabelMapping-reference-TextBox REQUIRED\n" +
                "      AnchorListComponent\n" +
                "        FlexLayoutComponent\n" +
                "          ROW\n" +
                "            \"Save\" DISABLED id=SpreadsheetLabelMapping-save-Link\n" +
    ...
    public void testOnHistoryTokenChangeSpreadsheetLabelMappingSelectHistoryTokenWithLabel() {
        this.onHistoryTokenChangeAndCheck(
            ...
            "SpreadsheetLabelMappingDialogComponent\n" +
                ...
                "        ValueTextBoxComponent\n" +
                "          TextBoxComponent\n" +
                "            Cell, cell range or Label [Label123] icons=mdi-close-circle id=SpreadsheetLabelMapping-reference-TextBox REQUIRED\n" +
                "      AnchorListComponent\n" +
                "        FlexLayoutComponent\n" +
                "          ROW\n" +
                "            \"Save\" DISABLED id=SpreadsheetLabelMapping-save-Link\n" +
    ...
    public void testOnHistoryTokenChangeSpreadsheetLabelMappingSelectHistoryTokenWithLabelNameAndSpreadsheetDeltaRefresh() {
        ...
        this.onHistoryTokenChangeAndCheck(
            ...
            "SpreadsheetLabelMappingDialogComponent\n" +
                ...
                "        ValueTextBoxComponent\n" +
                "          TextBoxComponent\n" +
                "            Cell, cell range or Label [C3] icons=mdi-close-circle id=SpreadsheetLabelMapping-reference-TextBox REQUIRED\n" +
                "      AnchorListComponent\n" +
                "        FlexLayoutComponent\n" +
                "          ROW\n" +
