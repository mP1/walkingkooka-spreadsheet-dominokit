    ...
    public void testOnHistoryTokenChangeWithSpreadsheetLabelMappingListHistoryTokenAndEmptyTable() {
        ...
        this.onHistoryTokenChangeAndCheck(
            ...
            "SpreadsheetLabelMappingListDialogComponent\n" +
                "  DialogComponent\n" +
                "    Labels\n" +
                "    id=SpreadsheetLabelMappingList-Dialog includeClose=true\n" +
                "      SpreadsheetDeltaLabelsTableComponent\n" +
                "        CardComponent\n" +
                "          Card\n" +
                "            DataTableComponent\n" +
                "              id=SpreadsheetLabelMappingList-labels-Table\n" +
                "              COLUMN(S)\n" +
                "                Label\n" +
                "                Cell\n" +
                "                Formatted\n" +
                ...
                "                FlexLayoutComponent\n" +
                "                  ROW\n" +
                "                    mdi-arrow-left \"previous\" DISABLED id=SpreadsheetLabelMappingList-previous-Link\n" +
                ...
                "        FlexLayoutComponent\n" +
                "          ROW\n" +
                "            \"Create\" [#/123/SpreadsheetName456/create-label] id=SpreadsheetLabelMappingList-create-Link\n" +
                "            \"Close\" [#/123/SpreadsheetName456] id=SpreadsheetLabelMappingList-close-Link\n"
        );
    }
    ...
    public void testOnHistoryTokenChangeWithSpreadsheetLabelMappingListHistoryTokenAndNotEmptyTable() {
        ...
        this.treePrintAndCheck(
            ...
            "SpreadsheetLabelMappingListDialogComponent\n" +
                ...
                "                      FlexLayoutComponent\n" +
                "                        ROW\n" +
                "                          \"References\" [#/123/SpreadsheetName456/cell/A1LABEL/references] (2) id=SpreadsheetLabelMappingList-labels-A1LABEL-references-Link\n" +
                "                          \"Delete\" [#/123/SpreadsheetName456/label/A1LABEL/delete] id=SpreadsheetLabelMappingList-labels-A1LABEL-delete-Link\n" +
                "                ROW 1\n" +
                ...
                "                      FlexLayoutComponent\n" +
                "                        ROW\n" +
                "                          \"References\" [#/123/SpreadsheetName456/cell/B2LABEL/references] (0) id=SpreadsheetLabelMappingList-labels-B2LABEL-references-Link\n" +
                "                          \"Delete\" [#/123/SpreadsheetName456/label/B2LABEL/delete] id=SpreadsheetLabelMappingList-labels-B2LABEL-delete-Link\n" +
                "              CHILDREN\n" +
                "                FlexLayoutComponent\n" +
                "                  ROW\n" +
                "                    mdi-arrow-left \"previous\" DISABLED id=SpreadsheetLabelMappingList-previous-Link\n" +
    ...
    public void testOnHistoryTokenChangeWithSpreadsheetLabelMappingListHistoryTokenWithOffset() {
        ...
        this.onHistoryTokenChangeAndCheck(
            ...
            "SpreadsheetLabelMappingListDialogComponent\n" +
                ...
                "                FlexLayoutComponent\n" +
                "                  ROW\n" +
                "                    mdi-arrow-left \"previous\" [#/123/SpreadsheetName456/label/*/offset/2] id=SpreadsheetLabelMappingList-previous-Link\n" +
                "                    \"next\" DISABLED mdi-arrow-right id=SpreadsheetLabelMappingList-next-Link\n" +
                "              PLUGINS\n" +
                "                BodyScrollPlugin\n" +
                "      AnchorListComponent\n" +
        ...
        this.treePrintAndCheck(
            ...
            "SpreadsheetLabelMappingListDialogComponent\n" +
                ...
                "                      FlexLayoutComponent\n" +
                "                        ROW\n" +
                "                          \"References\" [#/123/SpreadsheetName456/cell/C3LABEL/references] (0) id=SpreadsheetLabelMappingList-labels-C3LABEL-references-Link\n" +
                "                          \"Delete\" [#/123/SpreadsheetName456/label/C3LABEL/delete] id=SpreadsheetLabelMappingList-labels-C3LABEL-delete-Link\n" +
                "              CHILDREN\n" +
                "                FlexLayoutComponent\n" +
                "                  ROW\n" +
                "                    mdi-arrow-left \"previous\" [#/123/SpreadsheetName456/label/*/offset/2] id=SpreadsheetLabelMappingList-previous-Link\n" +
    ...
    public void testOnHistoryTokenChangeWithSpreadsheetCellLabelListHistoryToken() {
        ...
        this.onHistoryTokenChangeAndCheck(
            ...
            "SpreadsheetLabelMappingListDialogComponent\n" +
                ...
                "          ROW\n" +
                "            \"Create\" [#/123/SpreadsheetName456/create-label] id=SpreadsheetLabelMappingList-create-Link\n" +
                "            \"Close\" [#/123/SpreadsheetName456/cell/A1] id=SpreadsheetLabelMappingList-close-Link\n"
        );
