...
public class SpreadsheetColumnOrRowSpreadsheetComparatorNamesListComponentTest implements ValueTextBoxComponentLikeTesting<SpreadsheetColumnOrRowSpreadsheetComparatorNamesListComponent, SpreadsheetColumnOrRowSpreadsheetComparatorNamesList> {
    ...
    public void testSetValue() {
        this.treePrintAndCheck(
            ...
            "SpreadsheetColumnOrRowSpreadsheetComparatorNamesListComponent\n" +
                "  ValueTextBoxComponent\n" +
                "    TextBoxComponent\n" +
                "      [A=text;B=text-case-insensitive] icons=mdi-close-circle REQUIRED\n"
        );
    }
    ...
    public void testSetStringValueInvalidSecondColumn() {
        this.treePrintAndCheck(
            ...
            "SpreadsheetColumnOrRowSpreadsheetComparatorNamesListComponent\n" +
                "  ValueTextBoxComponent\n" +
                "    TextBoxComponent\n" +
                "      [A=good;!B=bad] icons=mdi-close-circle REQUIRED\n" +
                "      Errors\n" +
