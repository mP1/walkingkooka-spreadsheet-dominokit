    ...
    public void testSetStringValueWithInvalidSpreadsheetComparatorName() {
        this.treePrintAndCheck(
            ...
            "SpreadsheetComparatorInfoSetComponent\n" +
                "  ValueTextBoxComponent\n" +
                "    TextBoxComponent\n" +
                "      [https://example.com hello more more] icon=mdi-close-circle REQUIRED\n" +
                "      Errors\n" +
    ...
    public void testSetStringValueWithInvalidSecondAbsoluteUrl() {
        this.treePrintAndCheck(
            ...
            "SpreadsheetComparatorInfoSetComponent\n" +
                "  ValueTextBoxComponent\n" +
                "    TextBoxComponent\n" +
                "      [https://example.com/1 good,bad://example.com/2 bad] icon=mdi-close-circle REQUIRED\n" +
                "      Errors\n" +
    ...
    public void testSetStringValueWithInvalidSecondSpreadsheetComparatorName() {
        this.treePrintAndCheck(
            ...
            "SpreadsheetComparatorInfoSetComponent\n" +
                "  ValueTextBoxComponent\n" +
                "    TextBoxComponent\n" +
                "      [https://example.com/1 good,https://example.com/2 bad!] icon=mdi-close-circle REQUIRED\n" +
                "      Errors\n" +
