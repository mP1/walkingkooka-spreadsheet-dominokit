    ...
    public void testSetStringValueWithInvalidSecondUrl() {
        this.treePrintAndCheck(
            ...
            "SpreadsheetFormatterInfoSetComponent\n" +
                "  ValueTextBoxComponent\n" +
                "    TextBoxComponent\n" +
                "      [https://www.example.com/hello hello, bad://www.example.com hello2] icons=mdi-close-circle REQUIRED\n" +
                "      Errors\n" +
    ...
    public void testSetStringValueWithInvalidSecondSpreadsheetFormatterName() {
        this.treePrintAndCheck(
            ...
            "SpreadsheetFormatterInfoSetComponent\n" +
                "  ValueTextBoxComponent\n" +
                "    TextBoxComponent\n" +
                "      [https://www.example.com/hello good, https://www.example.com bad!] icons=mdi-close-circle REQUIRED\n" +
                "      Errors\n" +
