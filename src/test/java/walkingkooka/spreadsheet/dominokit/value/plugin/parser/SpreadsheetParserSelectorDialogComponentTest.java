    ...
    public void testOnHistoryTokenChangeCellDateMissingPattern() {
        ...
        this.onHistoryTokenChangeAndSetTextAndCheck(
            ...
            "SpreadsheetParserSelectorDialogComponent\n" +
                ...
                "          TextBoxComponent\n" +
                "            [date] icon=mdi-close-circle id=SpreadsheetParserSelector-TextBox REQUIRED\n" +
                "            Errors\n" +
                "              Empty \"text\"\n" +
    ...
    public void testOnHistoryTokenChangeCellDate() {
        ...
        this.onHistoryTokenChangeAndSetTextAndCheck(
            ...
            "SpreadsheetParserSelectorDialogComponent\n" +
                ...
                "        ValueTextBoxComponent\n" +
                "          TextBoxComponent\n" +
                "            [date dd/mm/yyyy] icon=mdi-close-circle id=SpreadsheetParserSelector-TextBox REQUIRED\n" +
                "      DialogAnchorListComponent\n" +
                "        AnchorListComponent\n" +
                "          FlexLayoutComponent\n" +
                "            ROW\n" +
    ...
    public void testOnHistoryTokenChangeCellDateTime() {
        ...
        this.onHistoryTokenChangeAndSetTextAndCheck(
            ...
            "SpreadsheetParserSelectorDialogComponent\n" +
                ...
                "        ValueTextBoxComponent\n" +
                "          TextBoxComponent\n" +
                "            [date-time dd/mm/yyyy hh:mm:ss] icon=mdi-close-circle id=SpreadsheetParserSelector-TextBox REQUIRED\n" +
                "      DialogAnchorListComponent\n" +
                "        AnchorListComponent\n" +
                "          FlexLayoutComponent\n" +
                "            ROW\n" +
    ...
    public void testOnHistoryTokenChangeCellNumber() {
        ...
        this.onHistoryTokenChangeAndSetTextAndCheck(
            ...
            "SpreadsheetParserSelectorDialogComponent\n" +
                ...
                "        ValueTextBoxComponent\n" +
                "          TextBoxComponent\n" +
                "            [number $#0.00] icon=mdi-close-circle id=SpreadsheetParserSelector-TextBox REQUIRED\n" +
                "      DialogAnchorListComponent\n" +
                "        AnchorListComponent\n" +
                "          FlexLayoutComponent\n" +
                "            ROW\n" +
    ...
    public void testOnHistoryTokenChangeCellTime() {
        ...
        this.onHistoryTokenChangeAndSetTextAndCheck(
            ...
            "SpreadsheetParserSelectorDialogComponent\n" +
                ...
                "        ValueTextBoxComponent\n" +
                "          TextBoxComponent\n" +
                "            [time hh:mm] icon=mdi-close-circle id=SpreadsheetParserSelector-TextBox REQUIRED\n" +
                "      DialogAnchorListComponent\n" +
                "        AnchorListComponent\n" +
                "          FlexLayoutComponent\n" +
                "            ROW\n" +
