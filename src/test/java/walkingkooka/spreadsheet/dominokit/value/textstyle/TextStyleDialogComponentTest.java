    ...
    public void testTextStyleSetStringValueWithInvalid() {
        ...
        this.treePrintAndCheck(
            ...
            "TextStyleDialogComponent\n" +
                ...
                "                ValueTextBoxComponent\n" +
                "                  TextBoxComponent\n" +
                "                    Border [left-color: black; right-color: black; right-style: SOLID; right-width: 1px; top-color: white; top-style: DASHED; top-width: 2px;] icons=mdi-close-circle id=TextStyle-border-TextBox\n" +
                "              BorderRightComponent\n" +
                "                ValueTextBoxComponent\n" +
                "                  TextBoxComponent\n" +
    ...
    public void testSetValueWithMetadataStyleWithoutTextStylePropertyName() {
        ...
        this.treePrintAndCheck2(
            ...
            "TextStyleDialogComponent\n" +
                ...
                "              FlexLayoutComponent\n" +
                "                ROW\n" +
                "                  \"Save\" [#/1/SpreadsheetName1/spreadsheet/style/*/save/background-color:%20black;%20border-left-color:%20black;%20border-right-color:%20black;%20border-right-style:%20SOLID;%20border-right-width:%201px;%20border-top-color:%20white;%20border-top-style:%20DASHED;%20border-top-width:%202px;%20color:%20black;%20direction:%20LTR;%20font-family:%20Courier;%20font-kerning:%20AUTO;%20font-size:%2099;%20font-stretch:%20NORMAL;%20font-style:%20ITALIC;%20font-variant:%20SMALL_CAPS;%20font-weight:%20BOLD;%20hanging-punctuation:%20FIRST;%20height:%2055px;%20hyphens:%20AUTO;%20letter-spacing:%2033px;%20line-height:%2044px;%20margin-bottom:%203px;%20margin-left:%204px;%20margin-right:%202px;%20margin-top:%201px;%20opacity:%2050%25;%20overflow-wrap:%20BREAK_WORD;%20overflow-x:%20VISIBLE;%20overflow-y:%20HIDDEN;%20padding-bottom:%203px;%20padding-left:%204px;%20padding-right:%202px;%20padding-top:%201px;%20text id=TextStyle-save-Link\n" +
    ...
    public void testTextStyleComponentValueWatcher() {
        ...
        this.treePrintAndCheck2(
            ...
            "TextStyleDialogComponent\n" +
                ...
                "                  \"Save\" [#/1/SpreadsheetName1/spreadsheet/style/*/save/background-color:%20black;%20border-left-color:%20black;%20border-right-color:%20black;%20border-right-style:%20SOLID;%20border-right-width:%201px;%20border-top-color:%20white;%20border-top-style:%20DASHED;%20border-top-width:%202px;%20color:%20black;%20direction:%20LTR;%20font-family:%20Courier;%20font-kerning:%20AUTO;%20font-size:%2099;%20font-stretch:%20NORMAL;%20font-style:%20ITALIC;%20font-variant:%20SMALL_CAPS;%20font-weight:%20BOLD;%20hanging-punctuation:%20FIRST;%20height:%2055px;%20hyphens:%20AUTO;%20letter-spacing:%2033px;%20line-height:%2044px;%20margin-bottom:%203px;%20margin-left:%204px;%20margin-right:%202px;%20margin-top:%201px;%20opacity:%2050%25;%20overflow-wrap:%20BREAK_WORD;%20overflow-x:%20VISIBLE;%20overflow-y:%20HIDDEN;%20padding-bottom:%203px;%20padding-left:%204px;%20padding-right:%202px;%20padding-top:%201px;%20text id=TextStyle-save-Link\n" +
                "                  \"Clear\" [#/1/SpreadsheetName1/spreadsheet/style/*/save/] id=TextStyle-clear-Link\n" +
                "                  \"Undo\" [#/1/SpreadsheetName1/spreadsheet/style/*/save/background-color:%20black;%20border-left-color:%20black;%20border-right-color:%20black;%20border-right-style:%20SOLID;%20border-right-width:%201px;%20border-top-color:%20white;%20border-top-style:%20DASHED;%20border-top-width:%202px;%20color:%20black;%20direction:%20LTR;%20font-family:%20Courier;%20font-kerning:%20AUTO;%20font-size:%2099;%20font-stretch:%20NORMAL;%20font-style:%20ITALIC;%20font-variant:%20SMALL_CAPS;%20font-weight:%20BOLD;%20hanging-punctuation:%20FIRST;%20height:%2055px;%20hyphens:%20AUTO;%20letter-spacing:%2033px;%20line-height:%2044px;%20margin-bottom:%203px;%20margin-left:%204px;%20margin-right:%202px;%20margin-top:%201px;%20opacity:%2050%25;%20overflow-wrap:%20BREAK_WORD;%20overflow-x:%20VISIBLE;%20overflow-y:%20HIDDEN;%20padding-bottom:%203px;%20padding-left:%204px;%20padding-right:%202px;%20padding-top:%201px;%20text id=TextStyle-undo-Link\n" +
                "                  \"Close\" [#/1/SpreadsheetName1] id=TextStyle-close-Link\n"
        );
    }
