...
public final class BorderRightComponentTest extends BorderSharedComponentTestCase<BorderRightComponent> {
    ...
    public void testAddValueWatcher() {
        ...
        final BorderRightComponent component = this.createComponent();
        component.addValueWatcher(
            new ValueWatcher<>() {
                @Override
                public void onValue(final Optional<Border> value) {
                    BorderRightComponentTest.this.fired = value.orElse(null);
                }
            }
        );

        final Border value = BoxEdge.RIGHT.parseBorder("black solid 1px");
    ...
    @Override
    public BorderRightComponent createComponent() {
        return BorderRightComponent.with("TestIdPrefix123-");
    }

    // class............................................................................................................

    @Override
    public Class<BorderRightComponent> type() {
        return BorderRightComponent.class;
    }
}
