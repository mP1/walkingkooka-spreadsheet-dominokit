...
public abstract class BorderSharedComponentTestCase<C extends BorderSharedComponent<C>> implements TextStylePropertyValueTextBoxComponentLikeTesting<C, Border> {

    BorderSharedComponentTestCase() {
        super();
    }
