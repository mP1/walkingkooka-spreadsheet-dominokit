    ...
    public void testSetValue() {
        this.treePrintAndCheck(
            ...
            "BorderTopColorComponent\n" +
                ...
                "        TextBoxComponent\n" +
                "          Border Top Color [#000001] icons=mdi-close-circle, mdi-palette id=TestIdPrefix-borderTopColor-TextBox REQUIRED\n" +
    ...
    public void testTextStyleValueWatcherOnValueChange() {
        ...
        this.treePrintAndCheck(
            ...
            "BorderTopColorComponent\n" +
                ...
                "      ValueTextBoxComponent\n" +
                "        TextBoxComponent\n" +
                "          Border Top Color [#000001] icons=mdi-close-circle, mdi-palette id=Test123-borderTopColor-TextBox REQUIRED\n" +
                "        ColorPaletteComponent\n" +
                "          TABLE\n" +
