...
public interface TextStylePropertyLengthComponentLikeTesting<C extends TextStylePropertyLengthComponentLike<C>>
    extends TextStylePropertyComponentTesting<HTMLFieldSetElement, Length<?>, C>,
    ValueTextBoxComponentLikeTesting<C, Length<?>> {
