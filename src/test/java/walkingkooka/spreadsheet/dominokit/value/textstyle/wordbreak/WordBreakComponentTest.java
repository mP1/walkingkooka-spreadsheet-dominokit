    ...
    public void testSetValue() {
        ...
        this.treePrintAndCheck(
            ...
            "WordBreakComponent\n" +
                ...
                "      FlexLayoutComponent\n" +
                "        ROW\n" +
                "          \"Clear\" [#/123/SpreadsheetName456/cell/A1/style/word-break/save/] id=Test123-wordBreak-Link\n" +
                "          \"Normal\" [#/123/SpreadsheetName456/cell/A1/style/word-break/save/NORMAL] id=Test123-wordBreak-NORMAL-Link\n" +
                "          \"Break All\" [#/123/SpreadsheetName456/cell/A1/style/word-break/save/BREAK_ALL] id=Test123-wordBreak-BREAK_ALL-Link\n" +
                "          \"Keep All\" [#/123/SpreadsheetName456/cell/A1/style/word-break/save/KEEP_ALL] id=Test123-wordBreak-KEEP_ALL-Link\n" +
                "          \"Break Word\" [#/123/SpreadsheetName456/cell/A1/style/word-break/save/BREAK_WORD] CHECKED id=Test123-wordBreak-BREAK_WORD-Link\n"
        );
    }
    ...
    public void testTextStyleValueWatcherOnValueChange() {
        ...
        this.treePrintAndCheck(
            ...
            "WordBreakComponent\n" +
                ...
                "        ROW\n" +
                "          \"Clear\" [#/123/SpreadsheetName456/cell/A1/style/word-break/save/] id=Test123-wordBreak-Link\n" +
                "          \"Normal\" [#/123/SpreadsheetName456/cell/A1/style/word-break/save/NORMAL] CHECKED id=Test123-wordBreak-NORMAL-Link\n" +
                "          \"Break All\" [#/123/SpreadsheetName456/cell/A1/style/word-break/save/BREAK_ALL] id=Test123-wordBreak-BREAK_ALL-Link\n" +
                "          \"Keep All\" [#/123/SpreadsheetName456/cell/A1/style/word-break/save/KEEP_ALL] id=Test123-wordBreak-KEEP_ALL-Link\n" +
                "          \"Break Word\" [#/123/SpreadsheetName456/cell/A1/style/word-break/save/BREAK_WORD] id=Test123-wordBreak-BREAK_WORD-Link\n"
        );
    }
