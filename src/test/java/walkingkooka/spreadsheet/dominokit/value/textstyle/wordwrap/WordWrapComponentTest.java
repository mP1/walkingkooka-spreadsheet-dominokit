...
public final class WordWrapComponentTest implements HtmlComponentTesting<WordWrapComponent, HTMLFieldSetElement> {

    @Test
    public void testSetValue() {
        final WordWrapComponent component = WordWrapComponent.with(
            "Test123-",
