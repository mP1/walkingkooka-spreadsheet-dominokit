...
import walkingkooka.spreadsheet.viewport.SpreadsheetViewportNavigationContextTesting2;

public final class SpreadsheetViewportComponentSpreadsheetViewportComponentTableContextSpreadsheetViewportNavigationContextTest implements SpreadsheetViewportNavigationContextTesting2<SpreadsheetViewportComponentSpreadsheetViewportComponentTableContextSpreadsheetViewportNavigationContext> {
    ...
    @Override
    public void testMoveDownPixelsWithNullRowFails() {
        throw new UnsupportedOperationException();
    }

    @Override
    public void testMoveDownPixelsWithNegativePixelsFails() {
        throw new UnsupportedOperationException();
    }
