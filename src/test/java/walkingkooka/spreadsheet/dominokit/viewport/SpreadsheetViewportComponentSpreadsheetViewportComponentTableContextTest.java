...
public final class SpreadsheetViewportComponentSpreadsheetViewportComponentTableContextTest implements SpreadsheetViewportComponentTableContextTesting<SpreadsheetViewportComponentSpreadsheetViewportComponentTableContext> {
    ...
    public String typeNameSuffix() {
        return SpreadsheetViewportComponentTableContext.class.getSimpleName();
    }

    @Override
    public Class<SpreadsheetViewportComponentSpreadsheetViewportComponentTableContext> type() {
        return SpreadsheetViewportComponentSpreadsheetViewportComponentTableContext.class;
    }
}
