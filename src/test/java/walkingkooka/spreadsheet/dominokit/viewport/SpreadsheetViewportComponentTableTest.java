...
public final class SpreadsheetViewportComponentTableTest implements HtmlComponentTesting<SpreadsheetViewportComponentTable, HTMLTableElement> {
    ...
    public void testOnKeyDownEventWithScreenUp() {
        this.onKeyDownEventAndCheck(
            ...
            null, // HistoryToken
            SpreadsheetViewportNavigation.scrollUp(150)
        );
    }
    ...
    public void testOnKeyDownEventWithScreenDown() {
        this.onKeyDownEventAndCheck(
            ...
            null, // HistoryToken
            SpreadsheetViewportNavigation.scrollDown(150)
        );
    }
    ...
    public void testOnKeyDownEventWithExtendScreenLeft() {
        this.onKeyDownEventAndCheck(
            ...
            null, // HistoryToken
            SpreadsheetViewportNavigation.extendScrollLeft(300)
        );
    }

    @Test
    public void testOnKeyDownEventWithExtendScreenRight() {
        this.onKeyDownEventAndCheck(
            shiftedKey(Key.End),
            HistoryToken.cellSelect(
                SPREADSHEET_ID,
            ...
            null, // HistoryToken
            SpreadsheetViewportNavigation.extendScrollRight(300)
        );
    }
    ...
    public void testOnKeyDownEventWithExtendScreenUp() {
        this.onKeyDownEventAndCheck(
            ...
            null, // HistoryToken
            SpreadsheetViewportNavigation.extendScrollUp(150)
        );
    }

    @Test
    public void testOnKeyDownEventWithExtendScreenDown() {
        this.onKeyDownEventAndCheck(
            ...
            null, // HistoryToken
            SpreadsheetViewportNavigation.extendScrollDown(150)
        );
    }
