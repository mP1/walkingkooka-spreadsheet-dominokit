...
public final class SpreadsheetViewportToolbarTest implements ClassTesting<SpreadsheetViewportToolbar> {
    ...
    @Override
    public Class<SpreadsheetViewportToolbar> type() {
        return SpreadsheetViewportToolbar.class;
    }
